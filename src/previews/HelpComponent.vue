  ...
  <div class="popup-container">
    <div class="popup-box">
      <div class="popup-content help-box">
        <!-- header -->
        <div class="header-info" :class="{ 'with-image': getHeaderImage }" v-if="options.title || options.header">
          ...
          <div>
            <label class="mc-checkbox">
              <span style="word-break: break-all;">{{ t('scComponents.help.accept') }}
                ...
                <span v-if="prize && prize.terms">
                  {{ t('scComponents.help.and') }}
                  <a :href="prize.terms" :download="t('scComponents.help.prizeterms')">{{ t('scComponents.help.prizeterms') }}</a>
                </span>
              </span>
